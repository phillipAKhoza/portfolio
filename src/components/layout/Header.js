                ...
                <div className="container">
                    ...
                    <div className="collapse navbar-collapse justify-content-end" id="navbarSupportedContent" data-toggle="collapse" data-target=".navbar-collapse">
                        ...
                        <div className="form-inline my-2 my-lg-0">
                         <a className="btn download btn-outline-warning my-2 my-sm-0" type="submit" href="https://drive.google.com/file/d/1zZhGd1kO8BlzcjN1wfuHl28z8HsCkidL/view?usp=sharing" onClick={this.handleClick}>Download CV <i className="fa fa-download featured-icon"></i></a>
                        </div>
                    </div>
                </div>
            </nav>
